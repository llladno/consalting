...
CREATE TABLE `mainorder` (
  ...
  CONSTRAINT `mainorder_ibfk_1` FOREIGN KEY (`idservice`) REFERENCES `service` (`idserice`),
...
INSERT INTO `mainorder` VALUES (1,1,1,'ivanov_ii@example.com',1500,'31.10.2023'),(2,1,9,'ivanov_ii@example.com',3000,'31.10.2023');
